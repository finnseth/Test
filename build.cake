...
Task("PersistClientEnvironment")
    .Does(() => {
        try {
            var content = "// This file is automatically generated by Cake -target PersistClientEnvironment script\n" +
                $"export const ClientEnvironment = {{ 'version': '{version}', 'location': 'Shore' }};\n";
...
Task("Build")
	.IsDependentOn("SetTeamCityVersion")
	.IsDependentOn("PersistClientEnvironment")
