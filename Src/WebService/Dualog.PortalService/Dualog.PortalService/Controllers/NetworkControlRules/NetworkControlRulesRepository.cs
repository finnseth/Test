...
{
    public class NetworkControlRulesRepository
    {
        IDataContextFactory _dcFactory;

        public NetworkControlRulesRepository( IDataContextFactory dcFactory )
        {
            _dcFactory = dcFactory;
        }
        public async Task<IEnumerable<CompanyRule>> GetRulesForCompany( long companyId )
        {
        ...
        public async Task<IEnumerable<VesselRule>> GetRulesForVessel( long companyId, long vesselId )
        {
            using( var dc = _dcFactory.CreateContext() )
            {
